          ...
          {step === 5 && bookingResult && (
            <div className="card-body" style={{ padding: 48, textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
                <button onClick={() => window.print()} className="btn btn-outline" style={{ flex: 1, minWidth: 140 }}>Print Slip</button>
                <button onClick={() => navigate('/login')} className="btn btn-primary" style={{ flex: 1, minWidth: 140 }}>Back to Login</button>
              </div>
            </div>
          )}
