    ...
    return (
        <div style={{ minHeight: '100vh', fontFamily: 'Inter, sans-serif', background: 'var(--slate-50)' }}>
            ...
            <nav style={{
                ...
                <div className="mobile-only" style={{ display: 'none', gap: 8 }}>
            ...
            <section style={{ background: 'white', padding: '0', borderBottom: '1px solid var(--slate-200)' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', padding: '0' }}>
                    {STATS.map((s, i) => (
                        <div key={i} style={{
                            padding: '32px 24px',
                            textAlign: 'center',
                            ...
                            <div style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: 800, color: 'var(--navy-600)', fontFamily: 'Space Grotesk' }}>{s.value}</div>
